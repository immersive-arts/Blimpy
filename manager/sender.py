...
class Sender:
    ...
    def stack_hold(self, x, y, z, alpha):
        command = 'hold x=%f y=%f z=%f alpha=%f' % (x, y, z, alpha)
        self.counter = self.counter + 1
        self.client.publish('manager/blimps/b01/stack', command, 0, False)
        
    def stack_goto(self, x, y, z, alpha, t):

        command = 'goto x=%f y=%f z=%f alpha=%f t=%f' % (x, y, z, alpha, t)
        self.counter = self.counter + 1
        self.client.publish('manager/blimps/b01/stack', command, 0, False)
...
sender.stack_goto(0.0, 0.0, 0.0, 0.0, 20.0)
time.sleep(20.0)
sender.clear()
time.sleep(0.1)
