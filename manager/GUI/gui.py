...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rotation.setGeometry(QtCore.QRect(10, 320, 151, 491))
        ...
        self.reference_label = QtWidgets.QLabel(self.rotation)
        self.reference_label.setGeometry(QtCore.QRect(10, 290, 67, 19))
        self.reference_label.setObjectName("reference_label")
        self.q_pitch_slider = QtWidgets.QSlider(self.rotation)
        self.q_pitch_slider.setGeometry(QtCore.QRect(0, 360, 141, 16))
        self.q_pitch_slider.setMinimum(-10)
        self.q_pitch_slider.setMaximum(10)
        self.q_pitch_slider.setProperty("value", 0)
        self.q_pitch_slider.setOrientation(QtCore.Qt.Horizontal)
        self.q_pitch_slider.setObjectName("q_pitch_slider")
        self.q_roll_slider = QtWidgets.QSlider(self.rotation)
        self.q_roll_slider.setGeometry(QtCore.QRect(0, 330, 141, 16))
        self.q_roll_slider.setMinimum(-10)
        self.q_roll_slider.setMaximum(10)
        self.q_roll_slider.setProperty("value", 0)
        self.q_roll_slider.setOrientation(QtCore.Qt.Horizontal)
        self.q_roll_slider.setObjectName("q_roll_slider")
        self.q_yaw_slider = QtWidgets.QSlider(self.rotation)
        self.q_yaw_slider.setGeometry(QtCore.QRect(0, 390, 141, 16))
        self.q_yaw_slider.setMinimum(-10)
        self.q_yaw_slider.setMaximum(10)
        self.q_yaw_slider.setProperty("value", 0)
        self.q_yaw_slider.setOrientation(QtCore.Qt.Horizontal)
        self.q_yaw_slider.setObjectName("q_yaw_slider")
        self.reference_roll_slider = QtWidgets.QLabel(self.rotation)
        self.reference_roll_slider.setGeometry(QtCore.QRect(30, 310, 67, 19))
        self.reference_roll_slider.setObjectName("reference_roll_slider")
        self.reference_pitch_slider = QtWidgets.QLabel(self.rotation)
        self.reference_pitch_slider.setGeometry(QtCore.QRect(30, 340, 67, 19))
        self.reference_pitch_slider.setObjectName("reference_pitch_slider")
        self.reference_yaw_label = QtWidgets.QLabel(self.rotation)
        self.reference_yaw_label.setGeometry(QtCore.QRect(30, 370, 67, 19))
        self.reference_yaw_label.setObjectName("reference_yaw_label")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.reference_label.setText(_translate("MainWindow", "Reference"))
        self.reference_roll_slider.setText(_translate("MainWindow", "Roll"))
        self.reference_pitch_slider.setText(_translate("MainWindow", "Pitch"))
        self.reference_yaw_label.setText(_translate("MainWindow", "Yaw"))
