...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 169.0, 98.0, 50.0, 22.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 61.0, 289.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 61.0, 249.0, 94.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 61.0, 211.0, 196.0, 22.0 ],
													"text" : "prepend manager/blimps/b01/stack"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 61.0, 132.0, 121.0, 22.0 ],
													"text" : "pak 0. 0. 1. 0. 0. 0. 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 61.0, 170.0, 388.0, 22.0 ],
...
,
									"patching_rect" : [ 55.875, 378.0, 48.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"text" : "pathGenerator @update_rate 10 @base_topic manager @blimp_base_topic blimps @blimp_id b01 @rigidBody_id 1 @velolcity_filter 0.s"
												}
