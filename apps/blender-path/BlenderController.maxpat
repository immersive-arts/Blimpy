...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.333333333333485, 539.0, 285.0, 127.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.333333333333485, 539.0, 53.0, 127.0 ],
					"text" : "\n\n[fps]\n[fps]\n[symbol]\n[symbol]\n[symbol]\n[int]\n[m/s]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 699.333333333333485, 488.0, 88.0, 22.0 ],
					"text" : "blp.show.panel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.333333333333371, 483.0, 78.0, 22.0 ],
					"text" : "bpl.visualizer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 42.0, 715.0, 78.0 ],
					"text" : "This patch illustrates how to receive OSC data from blender to be used to controll managed blimps.\n\nIt relies on the  [blp.txrx.path.maxpat] abstraction which manages the connection to the blimp with all the necessary calculations and controlls."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 11.0, 243.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 125.5, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 192.5, 314.0, 141.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.333333333333485, 539.0, 163.0, 127.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 566.833333333333371, 158.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 272.333333333333371, 511.0, 218.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 616.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.625, 582.0, 87.0, 22.0 ],
					"text" : "prepend topics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 368.5, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.333333333333485, 337.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.333333333333485, 368.5, 92.0, 22.0 ],
					"text" : "prepend enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 581.0, 111.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 87.0, 435.0, 30.0, 30.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 151.5, 172.5, 70.0, 22.0 ],
													"text" : "loadmess 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 606.5, 167.0, 48.0, 22.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "int" ],
													"patching_rect" : [ 553.0, 103.0, 29.5, 22.0 ],
													"text" : "t i i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 606.5, 197.5, 29.5, 22.0 ],
													"text" : "t b i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 553.0, 224.0, 38.0, 22.0 ],
													"text" : "zl.reg"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "int", "int" ],
													"patching_rect" : [ 90.0, 172.5, 48.0, 22.0 ],
													"text" : "change"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 90.0, 110.0, 121.0, 22.0 ],
													"text" : "onebang"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 108.0, 77.0, 61.0, 22.0 ],
													"text" : "delay 100"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 90.0, 42.0, 222.0, 22.0 ],
													"text" : "t b b i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 553.0, 136.0, 29.5, 22.0 ],
													"text" : "/ 60"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 606.5, 136.0, 36.0, 22.0 ],
													"text" : "% 60"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 511.75, 71.0, 29.5, 22.0 ],
													"text" : "/ 20"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 90.0, 136.0, 29.5, 22.0 ],
													"text" : "1"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "int" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 90.0, 202.5, 24.0, 24.0 ],
													"presentation" : 1,
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 172.0, 375.0, 37.0, 375.0, 37.0, 29.0, 67.0, 29.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
,
					"patching_rect" : [ 54.0, 150.0, 311.0, 30.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.125, 158.0, 29.5, 22.0 ],
					"text" : "b01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.75, 158.0, 29.5, 22.0 ],
					"text" : "b01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.5, 158.0, 29.5, 22.0 ],
					"text" : "b01"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 408.5, 158.0, 87.0, 45.0 ],
					"text" : "FREEZE",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 535.125, 223.5, 41.0, 22.0 ],
					"text" : "s park"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.5, 223.5, 51.0, 22.0 ],
					"text" : "s freeze"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 716.5, 158.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 632.833333333333485, 158.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 681.5, 223.5, 94.0, 22.0 ],
					"text" : "s removeBlimps"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 598.75, 223.5, 74.0, 22.0 ],
					"text" : "s addBlimps"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 524.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 56.0, 552.0, 219.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.5, 488.0, 68.0, 22.0 ],
					"text" : "disconnect"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.5, 488.0, 53.0, 22.0 ],
					"text" : "connect"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 339.5, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@update_rate", 10, "@base_topic", "manager", "@blimp_base_topic", "blimps", "@blimp_name", "b01", "@data_fps", 25, "@tracking_id", 110, "@velocity_max", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 56.0, 446.875, 719.5, 25.625 ],
					"varname" : "blp.txrx.path",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.333333333333485, 539.0, 505.0, 131.75 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 187.75, 325.0, 219.75 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 393.333333333333485, 143.75, 394.0, 263.75 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 439.25, 734.0, 39.75 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 65.5, 650.0, 13.5, 650.0, 13.5, 422.0, 65.5, 422.0 ],
					"source" : [ "obj-16", 0 ]
				}
